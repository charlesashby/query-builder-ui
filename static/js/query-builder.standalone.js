...
<div id="{{= it.group_id }}" class="rules-group-container"> \
  <div class="rules-group-header"> \
    <div class="btn-group pull-right group-actions button-qb"> \
      ...
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn btn-xs btn-danger button-delete-qb" id="button-delete-qb_{{= it.group_id}}" data-delete="group"> \
